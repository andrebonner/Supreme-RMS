...
<div id="col2">		
	...
	<th> Option </th> </tr>
			...
			<?php foreach ($technical_providers as $technical_provider): ?>
				<tr>
					<form action="" method="post">
						<div>
						
				<td>	<?php htmlout($technical_provider['name']); ?> 
							
							<input type="hidden" name="id" value="<?php
									echo $technical_provider['id']; ?>"/>
						</td>
						
					<td> <?php htmlout($technical_provider['status']); ?> </td>
					<td>
